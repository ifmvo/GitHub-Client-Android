    ...
    private void logRequest(Request request) {
        try {
            ...
            if (headers != null && headers.size() > 0) {
                Logger.e(TAG, "headers : " + headers.toString());
            }
            ...
            if (requestBody != null) {
                ...
                if (mediaType != null) {
                    if (isText(mediaType)) {
                        Logger.d(TAG, "params : " + bodyToString(request));
                    } else {
                        Logger.d(TAG, "params : " + " maybe [file part] , too large too print , ignored!");
                    }
                }
            }
        } catch (Exception e) {
            ...
            if (body != null) {
                ...
                if (mediaType != null) {
                    if (isText(mediaType)) {
                        ...
                        Logger.json(Log.DEBUG, TAG, resp);
