...
//    private ImageView mRotateView;
    ...
    private ImageView ivLoading, ivBg;
...
//        buildAnimation();
        View header = LayoutInflater.from(getContext()).inflate(R.layout.refreshrecycle_header_refresh, this);

//        mRotateView = (ImageView) header.findViewById(R.id.ptr_classic_header_rotate_view);
        ivLoading = (ImageView) header.findViewById(R.id.ivLoading);
        ivBg = (ImageView) header.findViewById(R.id.ivBg);
...
//        mRotateView.setVisibility(INVISIBLE);
    ...
    public void onUIRefreshPrepare(PtrFrameLayout frame) {
        Log.d("xxxx", "onUIRefreshPrepare-" + frame.getOffsetToRefresh());
        mShouldShowLastUpdate = true;
        tryUpdateLastUpdateTime();
...
//        mRotateView.setVisibility(VISIBLE);
    ...
    public void onUIRefreshBegin(PtrFrameLayout frame) {
        Log.d("xxxx", "onUIRefreshBegin-" + frame.getOffsetToRefresh());
...
//        mProgressBar.setVisibility(VISIBLE);
    ...
    public void onUIRefreshComplete(PtrFrameLayout frame) {
        Log.d("xxxx", "onUIRefreshComplete-" + frame.getOffsetToRefresh());
        hideRotateView();
        AnimationDrawable animationDrawable = (AnimationDrawable) ivLoading.getDrawable();
        animationDrawable.stop();
        ivLoading.setVisibility(INVISIBLE);
//        mProgressBar.setVisibility(INVISIBLE);
...
//        final int lastPos = ptrIndicator.getLastPosY();
        final float alpha = currentPos * 1.0f / ivBg.getHeight();
        ivLoading.setAlpha(alpha);
        ivBg.setAlpha(alpha);
